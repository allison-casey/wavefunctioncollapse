...
//	    	  System.out.println(x);
	...
	static void runTiledModel() {
	    ...
	    try {
	      ...
	      List<HashMap<String, String>> tiles = initTilesData();
	      List<HashMap<String, String>> neighborsData = initNeighborsData();
	      HashMap<String, String[]> subsetsData = new HashMap<String, String[]>();
	      ...
	      HashMap<String, BufferedImage> tileData = new HashMap<String, BufferedImage>();
